...
User sets status → 0 (Pending) or 1 (Completed)
...
User chooses from 5 simple options
 4. Scalable (100 Tasks Supported)

Uses an array of 100 structures

Can be increased if needed
 5. Fully Console-Based
